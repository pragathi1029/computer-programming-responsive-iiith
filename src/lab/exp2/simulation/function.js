window.view = {
	...
	validateRectangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a right triangle requires the length of the two perpendicular sides of the right triangle other than hypotenuse. Try again.')
		else if ( b !== 'float' )
	...
	displayFunctionForRectangle: function() {
		document.getElementById('functionRectangle').innerHTML += 'float area_right_tri (float a,float b)<br>{<br> &emsp; float area = (1/2.0)*a*b;<br> &emsp; return area;<br>}'
	},
